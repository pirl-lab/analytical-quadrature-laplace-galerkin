function plot_Fig_onetouch
load('Fig_onetouch_data.mat','ep1','epsi','errL','errM','errN')
...
lin=C./ep1;
loglog(ep1(1:3:length(ep1)),lin(1:3:length(ep1)),'k-');
legend('Weakly singular','Singular','Hypersingular','rel diff=A\epsilon','rel diff=B\epsilon','rel diff=C\epsilon')
