function I=I2ds(a1,a2,e2,h3,h4)
...
if abs(1+s0(1))>zerotol
    I=I+(1+s0(1))*I1d(a2,e2x+a1,h2,h3,h4);
end
if abs(s0(1))>zerotol
    I=I-s0(1)*I1d(a2,e2x,h2,h3,h4);
end
if abs(1+s0(2))>zerotol
    I=I+(1+s0(2))*I1d(a1,e2x+a2,h2,h3,h4);
end
if abs(s0(2))>zerotol
    I=I-s0(2)*I1d(a1,e2x,h2,h3,h4);
end
