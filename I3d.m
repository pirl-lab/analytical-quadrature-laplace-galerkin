...
if abs(1+s0(1)+s0(2))>zerotol
    I=I+(1+s0(1)+s0(2))*I2ds(a1-a2,a3,e3x+a2,h3,h4);
end
if abs(s0(1))>zerotol
    I=I-s0(1)*I2ds(a2,a3,e3x,h3,h4);
end
if abs(s0(2))>zerotol
    I=I-s0(2)*I2ds(a1,a3,e3x,h3,h4);
end
if abs(1+s0(3))>zerotol
    I=I+(1+s0(3))*I2dt(a1,a2,e3x+a3,h3,h4);
end
if abs(s0(3))>zerotol
    I=I-s0(3)*I2dt(a1,a2,e3x,h3,h4);
end
